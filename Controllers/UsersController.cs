...
namespace KuaforApp.Controllers
{
    public class UsersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,FullName,Email,Password,ConfirmPassword,CreatedAt,Role")] User user)
        {
            if (ModelState.IsValid)
            {
                _context.Add(user);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FullName,Email,Password,ConfirmPassword,CreatedAt,Role")] User user)
        {
            if (id != user.Id)
            {
                return NotFound();
