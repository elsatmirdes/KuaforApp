...
namespace KuaforApp.Controllers
{
    public class SalonsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Address,ContactNumber")] Salon salon)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Address,ContactNumber")] Salon salon)
        {
            if (id != salon.Id)
            {
                return NotFound();
